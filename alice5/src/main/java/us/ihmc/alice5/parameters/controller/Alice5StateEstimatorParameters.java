...
public class Alice5StateEstimatorParameters extends StateEstimatorParameters
{
   ...
   public Alice5StateEstimatorParameters(double estimatorDT, RobotTarget target, Alice5SensorInformation sensorInformation, Alice5JointMap jointMap)
   {
      this.target = target;
   ...
   {
      return toJointNameStrings(ArmJointName.SHOULDER_PITCH, ArmJointName.SHOULDER_ROLL, ArmJointName.ELBOW_PITCH);
   }
