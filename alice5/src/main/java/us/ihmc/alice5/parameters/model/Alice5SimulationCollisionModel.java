...
/**
 * Collision model for Alice5 used for simulating shape-to-shape collisions.
 * {@link DRCSCSInitialSetup#setUseExperimentalPhysicsEngine(boolean)}.
 * </p>
 *
 * @author Sylvain Bertrand
 */
public class Alice5SimulationCollisionModel implements RobotCollisionModel
{
   ...
   public Alice5SimulationCollisionModel(HumanoidJointNameMap jointMap, Alice5PhysicalProperties physicalProperties)
   {
      this(jointMap, physicalProperties, true);
   }

   public Alice5SimulationCollisionModel(HumanoidJointNameMap jointMap, Alice5PhysicalProperties physicalProperties, boolean useSTPShapesForSmoothContact)
   {
