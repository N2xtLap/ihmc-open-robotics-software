package us.ihmc.alice5.parameters.diagnostic;
...
public class Alice5DiagnosticParameters extends DiagnosticParameters
{
   ...
   public Alice5DiagnosticParameters(RobotTarget target,
