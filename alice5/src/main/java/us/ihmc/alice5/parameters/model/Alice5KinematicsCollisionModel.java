...
public class Alice5KinematicsCollisionModel implements RobotCollisionModel
{
   private final HumanoidJointNameMap jointMap;

   public Alice5KinematicsCollisionModel(HumanoidJointNameMap jointMap)
   {
   ...
   public List<Collidable> getRobotCollidables(MultiBodySystemBasics multiBodySystem)
   {
      ...
      for (RobotSide robotSide : RobotSide.values)
      {
         ...
         JointBasics shoulderJoint = RobotCollisionModel.findJoint(jointMap.getArmJointName(robotSide, ArmJointName.SHOULDER_ROLL), multiBodySystem);
