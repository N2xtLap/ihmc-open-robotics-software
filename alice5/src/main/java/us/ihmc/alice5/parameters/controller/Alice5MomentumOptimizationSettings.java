...
public class Alice5MomentumOptimizationSettings extends MomentumOptimizationSettings
{
   ...
   public Alice5MomentumOptimizationSettings(RobotTarget target, HumanoidJointNameMap jointMap)
   {
      this(target, jointMap, 2);
   }

   public Alice5MomentumOptimizationSettings(RobotTarget target, HumanoidJointNameMap jointMap, int numberOfContactableBodies)
   {
      ...
      armJointspaceWeight = Alice5WalkingControllerParameters.RESPONSIVE_STREAMING_MODE ? 3.0 : 1.0;
