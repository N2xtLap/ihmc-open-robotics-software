...
public class Alice5RigidBodyMutator implements Consumer<RobotDefinition>
{
   private Alice5PhysicalProperties physicalProperties;
   private final String[] imuSensorsToIgnore;

   public Alice5RigidBodyMutator(Alice5PhysicalProperties physicalProperties, String... imuSensorsToIgnore)
   {
