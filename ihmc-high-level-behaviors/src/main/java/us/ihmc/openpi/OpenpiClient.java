...
public class OpenpiClient
{
   ...
   private final ByteBuffer state = ByteBuffer.allocate(28 * Float.BYTES);
   ...
   private final ByteBuffer actions = ByteBuffer.allocate(50 * 28 * Double.BYTES);
      ...
      try
      {
         ...
         for (RobotSide side : RobotSide.values)
         {
            ...
            packer.packString("state").packMapHeader(4);
               ...
               packer.packString("shape").packArrayHeader(1).packInt(28);
            packer.packString("prompt").packString("0. Touch handle.");
      ...
      try
      {
         ...
         unpacker.unpackMapHeader(); // 3
            ...
            unpacker.unpackMapHeader(); // 4
               ...
               unpacker.unpackBinaryHeader(); // 50 * 28 * 8
