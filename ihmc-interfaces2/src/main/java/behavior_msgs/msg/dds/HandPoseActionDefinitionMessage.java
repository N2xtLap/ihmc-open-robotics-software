...
(behavior_msgs/HandPoseActionDefinitionMessage.msg)
##################################################################################
...
public class HandPoseActionDefinitionMessage implements ROS2Message<HandPoseActionDefinitionMessage>
{
   ...
   */
   ...
   public int calculateSizeBytes(int currentAlignment)
   {
      ...
      currentAlignment += 4 + CDRBuffer.alignment(currentAlignment, 4); // preset_
